...
fun getSo2Index(value: Int): AQI = when {
    value < 20 -> AQI.GOOD
...
fun getNo2Index(value: Int): AQI = when {
    value < 40 -> AQI.GOOD
...
fun getPm10Index(value: Int): AQI = when {
    value < 20 -> AQI.GOOD
...
fun getPm25Index(value: Int): AQI = when {
    value < 10 -> AQI.GOOD
...
fun getO3Index(value: Int): AQI = when {
    value < 60 -> AQI.GOOD
...
fun getC0Index(value: Int): AQI = when {
    value < 4400 -> AQI.GOOD
